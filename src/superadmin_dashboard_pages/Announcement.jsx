                                            ...
                                            <div class="accordion accordion-primary" id="accordion-one">
                                                <div class="accordion-item">
                                                    <div class="accordion-header " id="headingOne" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne" aria-expanded="true" role="button">
                                                        ...
                                                        <span class="accordion-header-text">Announcement</span>
                                                        ...
                                                        <div class="accordion-body-text">
                                                            <div class="default-tab">
                                                                <ul class="nav nav-tabs" role="tablist">
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link active" data-bs-toggle="tab" to="#home"><i class="la la-list me-2"></i>General</Link>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link" data-bs-toggle="tab" to="#profile"><i class="la la-users me-2"></i> Vendors</Link>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link" data-bs-toggle="tab" to="#contact"><i class="la la-user me-2"></i> Users</Link>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link" data-bs-toggle="tab" to="#message"><i class="la la-bicycle me-2"></i> Riders</Link>
                                                                    </li>
                                                                </ul>
                                                                                ...
                                                                                <div className="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group position-relative">
                                                                                            ...
                                                                                            <input type="text" class="form-control pl-5" placeholder="" name="from" required="" />
                                                                                        </div>
                                                                                    </div>
                                                                                    {/* <!--end col--> */}
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group position-relative">
                                                                                            ...
                                                                                            <textarea type="text" class="form-control pl-5" placeholder="" name="Certificate" required=""></textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    {/* <!--end col--> */}
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group position-relative">
                                                                                            <h6 className="size">Attachment</h6>
                                                                                            {/* <img src="images/icons/user.svg" className="fea icon-sm icons" id="okay" alt="user" /> */}
                                                                                            <input type="file" class="form-control pl-5" placeholder="" name="NameonAccount" required="" />
                                                                                        </div>
                                                                                    </div>
                                                                                    {/* <!--end col--> */}
