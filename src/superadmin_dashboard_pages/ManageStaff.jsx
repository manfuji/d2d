                    ...
                    <div className="container-fluid">
                        <div className="form-head d-flex mb-3 align-items-start">
                            <div className="me-auto d-none d-lg-block">
                                <h3 className="font-w600 mb-0">Manage Staffs</h3>
                                <small className="mb-0">Welcome to manage staff's page!</small>
                            </div>
                                                    ...
                                                    <form className="login-form mt-4 scroll" id="style">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12 mb-0">
                                                                ...
                                                                } className="btn btn-block" id="login">Update Staff</button>
                                                            </div>
                                                            {/* // <!--end col--> */}
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-responsive-md">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>542</td>
                                                        <td><span class="w-space-no">Adom Grace</span></td>
                                                    ...
                                                    <tr>
                                                        <td>589</td>
                                                        <td><span class="w-space-no">Maame Yaa</span></td>
