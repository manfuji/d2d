                        ...
                        <div className="container-fluid">
                            <div className="form-head d-flex mb-3 align-items-start">
                                <div className="me-auto d-none d-lg-block">
                                    <h3 className="font-w600 mb-0">Add Staff</h3>
                                    <small className="mb-0">Welcome to add staff's page!</small>
                                </div>
                            ...
                            <div className="row">
                                <div className="">
                                    <button className="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="filter" style={{ width: "15%", float: "right" }}>New Staff <img src="images/icons/plus.svg" width={20} alt="icons" /></button>
                                                    ...
                                                    <form className="login-form mt-4 scroll" id="style">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12 mb-0">
                                                                ...
                                                                } className="btn btn-block" id="login">Add Staff</button>
                                                            </div>
                                                            {/* // <!--end col--> */}
