                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative">
                                                                        ...
                                                                        <input type="text" class="form-control pl-5" placeholder="" name="shoplocation" required="" />
                                                                    </div>
                                                                </div>
                                                                {/* <!--end col--> */}
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative">
                                                                        <h6 className="size">Shop Registration Details</h6>
                                                                        {/* <img src="images/icons/phone.svg" className="fea icon-sm icons" id="okay" alt="phone" /> */}
                                                                        <input type="text" class="form-control pl-5" placeholder="" name="ShopRegistration" required="" />
                                                                    </div>
                                                                </div>
                                                                {/* <!--end col--> */}
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative">
                                                                        ...
                                                                        {/* <img src="images/icons/mail.svg" className="fea icon-sm icons" id="okay" alt="address" /> */}
                                                                        <input type="text" class="form-control pl-5" placeholder="" name="Address" required="" />
                                                                    </div>
                                                                </div>
                                                                {/* <!--end col--> */}
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group position-relative">
                                                                        ...
                                                                        {/* <img src="images/icons/shop.svg" className="fea icon-sm icons" id="okay" alt="mail" /> */}
                                                                        <input type="text" class="form-control pl-5" placeholder="" name="NumberEmployees" required="" />
                                                                    </div>
                                                                </div>
                                                                {/* <!--end col--> */}
                                                                ...
                                                                <div className="col-lg-12 mb-0">
                                                                    ...
                                                                    } className="btn btn-block" id="login">Update Vendor</button>
                                                                </div>
                                                                {/* // <!--end col--> */}
