                ...
                <div id="main-wrapper">
                    <div className="content-body">
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                <div className="">
                                    <button className="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="filter" style={{ width: "15%", float: "right" }}>New Rider <img src="images/icons/plus.svg" width={20} alt="icons" /></button>
