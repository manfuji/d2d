      ...
      <div class="chatbox">
        ...
        <div class="custom-tab-1">
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <Link class="nav-link" data-bs-toggle="tab" to="#">
                Notes
              </Link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <Link class="nav-link active" data-bs-toggle="tab" to="#">
                Chat
              </Link>
            </li>
          </ul>
                    ...
                    <li class="active">
                      <div class="d-flex bd-highlight">
                        ...
                        <div class="ms-auto">
                          ...
                          <Link to="#" class="btn btn-danger btn-xs sharp">
              ...
              <ul class="navbar-nav header-right">
                ...
                <li class="nav-item dropdown notification_dropdown">
                  ...
                  >
                    ...
                    <div class="pulse-css">
                      <span className="text-primary mb-5">
                        {user?.notification?.length}9
                      </span>
                    </div>
                  </Link>
