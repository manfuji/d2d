		...
		<>
			<div class="nav-header">
				<Link to="#" class="brand-logo">
					<img class="logo-compact" src="images/logo/logo.png" width={100} alt="logo" />
					<img class="brand-title" src="images/logo/logo.png" width={100} alt="logo" />
				</Link>
			...
			<div class="chatbox">
				...
				<div class="custom-tab-1">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<Link class="nav-link" data-bs-toggle="tab" to="#">Notes</Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link" data-bs-toggle="tab" to="#">Alerts</Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link active" data-bs-toggle="tab" to="#">Chat</Link>
						</li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane fade active show" id="chat" role="tabpanel">
							<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
								<div class="card-header chat-list-header text-center">
									<Link to="#"><svg width={18} height={18} viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect fill="#000000" x="4" y="11" width="16" height={2} rx="1" /></g>
									</svg></Link>
									<div>
										<h6 class="mb-1">Chat List</h6>
										<p class="mb-0">Show All</p>
									</div>
									<Link to="#"><svg width={18} height={18} viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24" /><circle fill="#000000" cx="5" cy="12" r="2" /><circle fill="#000000" cx="12" cy="12" r="2" /><circle fill="#000000" cx="19" cy="12" r="2" /></g></svg></Link>
								</div>
									...
									<ul class="contacts">
										...
										<li class="active dz-chat-user">
											<div class="d-flex bd-highlight">
												<div class="img_cont">
													<img src="images/avatar/MJ.jpg" class="rounded-circle user_img" alt="avatar" />
										...
										<li class="dz-chat-user">
											<div class="d-flex bd-highlight">
												<div class="img_cont">
													<img src="images/avatar/1.jpeg" class="rounded-circle user_img" alt="avatar" />
								...
								<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
									<div class="d-flex justify-content-start mb-4">
										<div class="img_cont_msg">
											<img src="images/avatar/MJ.jpg" class="rounded-circle user_img_msg" alt="avatar" />
										</div>
						...
						<div class="tab-pane fade" id="notes">
							<div class="card mb-sm-3 mb-md-0 note_card">
								<div class="card-header chat-list-header text-center">
									<Link to="#"><svg width={18} height={18} viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect fill="#000000" x="4" y="11" width="16" height="2" rx="1" /></g></svg></Link>
									<div>
									...
									<ul class="contacts">
										<li class="active">
											<div class="d-flex bd-highlight">
												...
												<div class="ms-auto">
													<Link to="#" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></Link>
													<Link to="#" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></Link>
												</div>
											</div>
										</li>
										<li>
							...
							<ul class="navbar-nav header-right">
								...
								<li class="nav-item dropdown notification_dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
												...
												<li>
													<div class="timeline-panel">
														<div class="media me-2">
															<img alt="avatar" width="50" src="images/avatar/MJ.jpg" />
														</div>
										...
										<Link class="all-notification" to="#">See all notifications <i class="ti-arrow-right"></i></Link>
									</div>
								</li>
								<li class="nav-item dropdown header-profile">
									<Link class="nav-link" to="#" role="button" data-bs-toggle="dropdown">
										<div class="header-info">
											<span>Hello, <strong>Samuel</strong></span>
										</div>
										<img src="images/avatar/MJ.jpg" width="20" alt="" />
									</Link>
									<div class="dropdown-menu dropdown-menu-right">
