    ...
    <div className="deznav">
      <div className="deznav-scroll">
        <ul className="metismenu" id="menu">
          <li>
            <Link className="ai-icon" to="/superadmin_dashboard">
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <Link to="/manage-vendors">Manage Vendor</Link>
              </li>
              <li>
          ...
          <li>
            <Link className="ai-icon" to="/approve-vendors">
              <i className="flaticon-381-user-9"></i>
          ...
          <li>
            ...
            <ul>
              <li>
                <Link to="/add-staff">Create Staffs</Link>
              </li>
              <li>
                <Link to="/manage-staffs">Manage Staffs</Link>
              </li>
            </ul>
          </li>
          <li>
            <Link className="has-arrow ai-icon" to="/add-offer">
              <i className="flaticon-381-user-9"></i>
              <span className="nav-text">Riders</span>
            </Link>
            <ul>
              <li>
                <Link to="/add-rider">Create Riders</Link>
              </li>
              <li>
                <Link to="/manage-riders">Manage Riders</Link>
              </li>
              {/* <li><Link to="/">Approve Riders</Link></li> */}
            </ul>
          </li>
          <li>
            <Link className=" ai-icon" to="/approve-rider">
              <i className="flaticon-381-notepad"></i>
              <span className="nav-text">Approve Riders</span>
            </Link>
          </li>
          <li>
            <Link className=" ai-icon" to="/access-tickets">
              <i className="flaticon-381-notepad"></i>
          ...
          <li>
            ...
            <ul>
              <li>
                <Link to="/financial-report">Financial Report</Link>
              </li>
              <li>
                <Link to="/system-report">System Report</Link>
              </li>
              <li>
                <Link to="/user-report">Users Report</Link>
              </li>
            </ul>
          </li>
          <li>
            <Link className="ai-icon" to="/announcements">
              <i className="flaticon-381-promotion"></i>
              <span className="nav-text">Announcements</span>
            </Link>
          </li>
          <li>
            <Link className="ai-icon" to="/withdrawals">
              <i className="flaticon-381-user-9"></i>
          ...
          <li>
            ...
            <ul>
              <li>
                <Link to="/shop-settings">SMS API's</Link>
              </li>
              <li>
                <Link to="/profile-settings">Account Settings</Link>
              </li>
              <li>
                <Link to="/payment-settings">Message templates</Link>
              </li>
            </ul>
          </li>
        </ul>
