                ...
                <div class="widget-carousel owl-carousel">
                  <div class="items">
                    <div class="bootstrap-media card p-4">
                      ...
                      <p class="f-13 text-black mb-4">
                        A very fine addition to the not over plentiful supply of
                        good restaurants in this part of west London.
                      </p>
                  ...
                  <div class="items">
                    <div class="bootstrap-media card p-4">
                      ...
                      <p class="f-13 text-black mb-4">
                        Fast, professional and friendly service, we ordered the
                        six course tasting menu and every dish was spectacular
                      </p>
                      <div class="reviewer-box">
                        <div class="media d-flex align-items-center">
