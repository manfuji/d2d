                ...
                <div id="main-wrapper">
                    <div className="content-body">
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                <div className="">
                                    <button className="btn btn-primary btn-sm ml-2" id="filter" style={{ width: "10%", float:"right"  }}>Print</button>
                                    <button className="btn btn-primary btn-sm ml-1" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="filter" style={{ width: "15%", float:"right" }}>Add Product <img src="images/icons/plus.svg" width={20} alt="icons" /></button>
