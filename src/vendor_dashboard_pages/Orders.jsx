            ...
            <div className="container-fluid">
              <div class="form-head d-flex mb-3 align-items-start">
                ...
                <div class="dropdown mb-md-3 mb-2 ms-auto">
                  <div
                    class="btn btn-primary btn-sm text-white dropdown-toggle"
                    ...
                    <div class="col-xl-12 col-lg-6 ">
                      <div class="card h-auto">
                        <div class="card-body text-center">
                          ...
                          <Link to="#" class="btn btn-primary light btn-xs">
                            Customer
                          </Link>
                        </div>
                        ...
                        <div class="card-body pt-2">
                          <div class="table-responsive ">
                            <table class="table items-table">
                              <tr>
                                <th class="my-0 text-black font-w500 fs-14">
                                  Items
                                </th>
                                <th
                                  style={{ width: "10%" }}
                                  class="my-0 text-black font-w500 fs-14"
                                >
                                  Qty
                                </th>
                                <th
                              ...
                              <tr>
                                <td>
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      ...
                                      <h4 class="mt-0 mb-2 mb-4 fs-14">
                                        <Link
                                          class="text-black fs-10"
                                ...
                                <td>
                                  <h4 class="my-0 text-secondary fs-14 font-w600">
                                    3x
                                  </h4>
                                </td>
                                <td>
                                ...
                                <td>
                                  <Link
                                    to="#"
                                    class="ti-close fs-15 text-danger las la-times-circle"
                                  ></Link>
                                </td>
                              </tr>
                              <tr>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="full-map-area mb-4">
                            ...
                            <Link to="#" class="btn btn-danger btn-xs">
                              View in Fullscreen
                            </Link>
                          ...
                          <div class="row mx-0">
                            <div class="media align-items-center col-md-4 col-lg-4 px-0 mb-3 mb-md-0">
                              ...
                              />
                              <div class="media-body">
                                <h5 class="my-0 text-black fs-12">
                                  Kevin Hobs Jr.
                                </h5>
