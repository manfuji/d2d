                            ...
                            <div className="form-head d-flex mb-3 align-items-start">
                                ...
                                <div className="dropdown custom-dropdown" id="filter">
                                    <div className="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-bs-toggle="dropdown">
                                        <svg width={28} height={28} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><g><path d="M22.4281 2.856H21.8681V1.428C21.8681 0.56 21.2801 0 20.4401 0C19.6001 0 19.0121 0.56 19.0121 1.428V2.856H9.71606V1.428C9.71606 0.56 9.15606 0 8.28806 0C7.42006 0 6.86006 0.56 6.86006 1.428V2.856H5.57206C2.85606 2.856 0.560059 5.152 0.560059 7.868V23.016C0.560059 25.732 2.85606 28.028 5.57206 28.028H22.4281C25.1241 28.028 27.4401 25.732 27.4401 23.016V7.868C27.4401 5.152 25.1241 2.856 22.4281 2.856ZM5.57206 5.712H22.4281C23.5761 5.712 24.5841 6.72 24.5841 7.868V9.856H3.41606V7.868C3.41606 6.72 4.42406 5.712 5.57206 5.712ZM22.4281 25.124H5.57206C4.42406 25.124 3.41606 24.136 3.41606 22.988V12.712H24.5561V22.988C24.5841 24.136 23.5761 25.124 22.4281 25.124Z"
                                            fill="#ffffff"></path></g></svg>
                                        <div className="text-start ms-3">
                                            <span className="d-block fs-14">Filter Periode</span>
                                            <small className="d-block fs-12">4 June 2020 - 4 July 2020</small>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header border-0 pb-0 d-sm-flex flex-wrap d-block">
                                            <div class="mb-3">
                                                ...
                                                <small class="mb-0 textSmall">Lorem ipsum dolor sit amet, consectetur</small>
                                            </div>
                                            <div class="card-action card-tabs mb-2">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li class="nav-item">
                                                        <Link class="nav-link active textSmallYeah" data-bs-toggle="tab" to="#Monthly" role="tab">
                                                            Monthly
                                                        </Link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <Link class="nav-link textSmallYeah" data-bs-toggle="tab" to="#Weekly" role="tab">
                                                            Weekly
                                                        </Link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <Link class="nav-link textSmallYeah" data-bs-toggle="tab" to="#Today" role="tab">
                                                            Today
                                                        </Link>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="card-body tab-content orders-summary pt-3">
                                            <div class="tab-pane fade show active" id="Monthly">
                                                <div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
                                                    <Link to="#" class="btn fs-22 text-white py-1 btn-success btn-sm px-4 me-3" id="btn25">25</Link>
                                                    <h4 class="mb-0 newOrderText">New Orders <i class="fa fa-circle text-warning ms-1 fs-15"></i></h4>
                                                    <Link to="#" class="ms-auto text-primary font-w500">Manage orders <i class="ti-angle-right ms-1"></i></Link>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-4 mb-4">
                                                        <div class="border px-3 py-1 rounded-xl">
                                                            <h5 class="fs-32 font-w600 counter">25</h5>
                                                            <p class="fs-16 mb-0 textSmallYeah">On Delivered</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 mb-4">
                                                        <div class="border px-3 py-1 rounded-xl">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <p class="mb-0 fs-12 me-2 col-4 col-xxl-5 px-0">Cakes (24%)</p>
                                                                <div class="progress mb-0" style={{ height: 8, width: "100%" }}>
                                                                    <div class="progress-bar bg-warning progress-animated" style={{ width: "85%", height: 8 }} role="progressbar">
                                                            ...
                                                            <div class="d-flex align-items-center  mb-3">
                                                                <p class="mb-0 fs-12 me-2 col-4 col-xxl-5 px-0">Cupcakes (41%)</p>
                                                                <div class="progress mb-0" style={{ height: 8, width: "100%" }}>
                                                                    <div class="progress-bar bg-success progress-animated" style={{ width: "70%", height: 8 }} role="progressbar">
                                                                        <span class="sr-only">60% Complete</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <p class="mb-0 fs-12 me-2 col-4 col-xxl-5 px-0">Cheesecakes (15%)</p>
                                                                <div class="progress mb-0" style={{ height: 8, width: "100%" }}>
                                                                    <div class="progress-bar bg-dark progress-animated" style={{ width: "30%", height: 8 }} role="progressbar">
                                                                        <span class="sr-only">60% Complete</span>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="Weekly">
                                                <div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
                                                    <Link to="#" class="btn fs-22 py-1 btn-success px-4 me-3">25</Link>
                                    ...
                                    <div class="card">
                                        <div class="card-header border-0 pb-0 d-sm-flex d-block">
                                            <div>
                                                ...
                                                <small class="mb-0 textSmall">This section of your page shows your incoming orders</small>
                                            </div>
                                        ...
                                        <div class="card-body revenue-chart px-3">
                                            ...
                                            <div class="card-body">
                                                <div id="DZ_W_TimeLine11" class="widget-timeline dz-scroll style-1">
                                                    <ul class="timeline">
                                                        <li className="shadow-sm">
                                                            <div class="timeline-badge primary"></div>
                                                            <Link class="timeline-panel text-muted" href="#">
                                                                <span>10 minutes ago</span>
                                                                <h6 class="mb-0">New order placed <strong class="text-primary">#0001.</strong></h6>
                                                        ...
                                                        <li className="shadow-sm"> 
                                                            ...
                                                            <Link class="timeline-panel text-muted" href="#">
                                                                ...
                                                                <h6 class="mb-0">New order placed <strong class="text-primary">#0003.</strong></h6>
                                                        ...
                                                        <li className="shadow-sm">
                                                            ...
                                                            <Link class="timeline-panel text-muted" href="#">
                                                                ...
                                                                <h6 class="mb-0">New order placed <strong class="text-primary">#0006.</strong></h6>
                                                        ...
                                                        <li className="shadow-sm">
                                                            ...
                                                            <Link class="timeline-panel text-muted" href="#">
                                                                <span>15 minutes ago</span>
                                                                <h6 class="mb-0">New order placed <strong class="text-primary">#0002.</strong></h6>
