                                        ...
                                        <div class="profile-head">
                                            ...
                                            <div class="profile-info">
                                                <div class="profile-photo">
                                                    <img src="images/avatar/1.jpeg" width={90} height={90} class="img-fluid rounded-circle" alt="profile" />
                                                </div>
                                                <div class="profile-details">
                                                    ...
                                                    <div class="profile-email px-2 pt-2">
                                                        <h4 class="text-muted mb-0 fs-12">info@example.com</h4>
                                            ...
                                            <div class="profile-tab">
                                                <div class="custom-tab-1">
                                                    <ul class="nav nav-tabs">
                                                        <li class="nav-item"><Link to="#about-me" data-bs-toggle="tab" class="nav-link">About Me</Link>
                                                        </li>
                                                        <li class="nav-item"><Link to="#profile-settings" data-bs-toggle="tab" class="nav-link">Setting</Link>
                                                        </li>
                                                    </ul>
