                        ...
                        <div className="container-fluid">
                            <div className="form-head d-flex mb-3 align-items-start">
                                <div className="me-auto d-none d-lg-block">
                                    <h3 className="font-w600 mb-0">Edit Products</h3>
                            ...
                            <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
                                <div class="me-auto d-none d-lg-block">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><Link to="#" class="text-primary">Recently Added Products</Link></li>
                                ...
                                <div class="col-md-12">
                                    <div class="widget-carousel owl-carousel">
                                        <div class="items">
                                            <div class="bootstrap-media card p-4">
                                                <div class="media mb-4 d-flex align-items-center">
                                                    <Link to="ecom-product-detail.html"><img class="me-3 img-fluid rounded-xl" width="94" src="images/dish/pic1.jpg" alt="DexignZone" /></Link>
                                                    <div class="media-body">
                                                        <h5 class="mt-0 mb-3 fs-13"><Link class="text-black" to="ecom-product-detail.html">Tuna soup spinach with himalaya salt</Link></h5>
                                                        <small class="mb-0"><Link class="text-primary" to="#">BURGER</Link></small>
                                                    </div>
                                                </div>
                                                <p class="f-13 text-black mb-4">A very fine addition to the not over plentiful supply of good restaurants in this part of west London.</p>
                                        ...
                                        <div class="items">
                                            <div class="bootstrap-media card p-4">
                                                <div class="media mb-4 d-flex align-items-center">
                                                    <Link to="ecom-product-detail.html"><img class="me-3 img-fluid rounded-xl" width="94" src="images/dish/pic2.jpg" alt="DexignZone" /></Link>
                                                    <div class="media-body">
                                                        <h5 class="mt-0 mb-3 fs-13"><Link class="text-black" to="ecom-product-detail.html">Chicken curry special with cucumber</Link></h5>
                                                        <small class="mb-0"><Link class="text-primary" to="#">PIZZA</Link></small>
                                                    </div>
                                                </div>
                                                <p class="f-13 text-black mb-4">Fast, professional and friendly service, we ordered the six course tasting menu and every dish was spectacular</p>
                                                <div class="reviewer-box">
                                                    <div class="media d-flex align-items-center">
                                                        {/* <img class="me-3 img-fluid rounded" width="55" src="images/avatar/2.jpg" alt="DexignZone" /> */}
                                                        <div class="media-body">
                                                            <h4 class="mt-0 mb-1 text-white fs-13">Pastries</h4>
                                                            <small class="mb-0 text-light fs-13">Pastires</small>
                                                        </div>
                                        ...
                                        <div class="items">
                                            <div class="bootstrap-media card p-4">
                                                <div class="media mb-4 d-flex align-items-center">
                                                    <Link to="ecom-product-detail.html"><img class="me-3 img-fluid rounded-xl" width="94" src="images/dish/pic3.jpg" alt="DexignZone" /></Link>
                                                    <div class="media-body">
                                                        <h5 class="mt-0 mb-3 fs-13"><Link class="text-black" to="ecom-product-detail.html">Tuna soup spinach with himalaya salt</Link></h5>
                                                        <small class="mb-0"><Link class="text-primary" to="#">JUICE</Link></small>
                                                    </div>
                                                </div>
                                                <p class="f-13 text-black mb-4">A very fine addition to the not over plentiful supply of good restaurants in this part of west London.</p>
                                                <div class="reviewer-box">
                                                    <div class="media d-flex align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <h4 class="mt-0 mb-1 text-white fs-13">Brownies</h4>
                                                            <small class="mb-0 text-light fs-13">Brownies</small>
                                                        </div>
                                                        <div class="star-review d-flex ms-2">
                                                            <i class="fa fa-star text-orange fs-13"></i>
                                        ...
                                        <div class="items">
                                            <div class="bootstrap-media card p-4">
                                                <div class="media mb-4 d-flex align-items-center">
                                                    <Link to="ecom-product-detail.html"><img class="me-3 img-fluid rounded-xl" width="94" src="images/dish/pic4.jpg" alt="DexignZone" /></Link>
                                                    <div class="media-body">
                                                        <h5 class="mt-0 mb-3 fs-13"><Link class="text-black" to="ecom-product-detail.html">Meidum Spicy Spagethi Italiano</Link></h5>
                                                        <small class="mb-0"><Link class="text-primary" to="#">BURGER</Link></small>
                                                    </div>
                                                </div>
                                                <p class="f-13 text-black mb-4">A very fine addition to the not over plentiful supply of good restaurants in this part of west London.</p>
                                                <div class="reviewer-box">
                                                    <div class="media d-flex align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <h4 class="mt-0 mb-1 text-white fs-13">Cheese Cake</h4>
                                                            <small class="mb-0 text-light fs-13">Cheese Cake</small>
                                                        </div>
                                        ...
                                        <div class="items">
                                            <div class="bootstrap-media card p-4">
                                                <div class="media mb-4 d-flex align-items-center">
                                                    <Link to="ecom-product-detail.html"><img class="me-3 img-fluid rounded-xl" width="94" src="images/dish/pic5.jpg" alt="DexignZone" /></Link>
                                                    <div class="media-body">
                                                        <h5 class="mt-0 mb-3 fs-13"><Link class="text-black" to="ecom-product-detail.html">Tuna soup spinach with himalaya salt</Link></h5>
                                                        <small class="mb-0"><Link class="text-primary" to="#">PIZZA</Link></small>
                                                    </div>
                                                ...
                                                <div class="reviewer-box">
                                                    <div class="media d-flex align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <h4 class="mt-0 mb-1 text-white fs-13">Cupcake</h4>
                                                            <small class="mb-0 text-light fs-13">Cupcake</small>
                                                        </div>
                                                        <div class="star-review d-flex ms-2">
                                                            <i class="fa fa-star text-orange fs-13"></i>
                                                            <span class="ms-2 fs-13">4.2</span>
                            ...
                            <div className="row">
                                <div className="">
                                    {/* <button className="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="filter" style={{ width: "15%" }}>Add Product <img src="images/icons/plus.svg" width={20} alt="icons" /></button> */}
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div className='form-group'>
                                                            ...
                                                            <select type="select" className="form-control" name="phonenumber">
                                                    ...
                                                    <div className='sweetalert mt-5 '>
                                                        ...
                                                        } className='btn btn-primary btn-block sweet-success' id="filter">
                                                            Add Product</button>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table table-responsive-md">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Cheese Cake</td>
                                                            <td>Cheese Cake</td>
                                                            <td><div class="d-flex align-items-center"><i class="fa fa-circle text-warning me-1"></i> GH₵ 250</div></td>
                                                            <td>
                                                                L
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <Link to="#" class="btn btn-primary shadow btn-xs sharp me-1" id="editIcon" data-bs-toggle="modal" data-bs-target="#basicModal"><i class="fas fa-pencil-alt"></i></Link>
                                                                    <Link to="#" onClick={() =>
                                                                        swal({
                                                                            title: "Are you sure?",
                                                                            text:
                                                                    ...
                                                                    } class="btn btn-danger shadow btn-xs sharp sweet-confirm"><i class="fa fa-trash"></i></Link>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <Link to="#" class="btn btn-primary shadow btn-xs sharp me-1" id="editIcon" ><i class="fas fa-pencil-alt"></i></Link>
                                                                    <Link to="#" onClick={() =>
                                                                        swal({
                                                                            title: "Are you sure?",
                                                                            text:
