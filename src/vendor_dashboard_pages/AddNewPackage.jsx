                ...
                <div id="main-wrapper">
                    <div className="content-body">
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                <div className="">
                                    <button className="btn btn-primary btn-sm" id="filter" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" style={{ width: "14%" }}>Add Package<img src="images/icons/plus.svg" width={20} alt="icons" /></button>
                                                    ...
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-6'>
                                                            ...
                                                            <div className='form-group'>
                                                                ...
                                                                <div id='multiselect'>
                                                                    <DropdownMultiselect
                                                                        options={['Free Candles', 'Plastic Knife', 'Chocolate', '4', '5', '6']}
                                                                    />
                                                                </div>
                                                            </div>
