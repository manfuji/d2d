          ...
          <div className="container-fluid">
            <div className="form-head d-flex mb-3 align-items-start">
              ...
              <div className="dropdown custom-dropdown">
                <button
                  type="button"
                  className="btn btn-primary btn-sm light d-flex align-items-center svg-btn"
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>$164.52</td>
                            <td>
                              <button className="btn btn-sm light btn-warning w-space-no fs-10">
                                New Order
                              </button>
                            </td>
                            <td>
                              <div class="dropdown ms-auto text-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  ...
                                  <Link class="dropdown-item" to="#">
                                    <i class="las la-check-square scale5 text-primary me-2"></i>{" "}
                                    Accept Order
                                  </Link>
                          ...
                          <tr>
                            ...
                            <td>$24.55</td>
                            <td>
                              <span class="btn btn-sm light btn-primary w-space-no">
                                On Delivery
                              </span>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>$251.16</td>
                            <td>
                              <span class="btn btn-sm light btn-success">
                                Delivered
                              </span>
                            </td>
                            <td>
