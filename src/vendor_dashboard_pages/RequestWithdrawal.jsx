                        ...
                        <div className="container-fluid">
                            <div className="form-head d-flex mb-3 align-items-start">
                                <div className="me-auto d-none d-lg-block">
                                    ...
                                    <small className="mb-0">Welcome to Your Withdrawal Request Options</small>
                                </div>
                            </div>
                            <hr />
                            <div className="row">
                                            ...
                                            <div class="accordion accordion-primary" id="accordion-one">
                                                <div class="accordion-item">
                                                    <div class="accordion-header " id="headingOne" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne" aria-expanded="true" role="button">
                                                        ...
                                                        <span class="accordion-header-text">Request Withdrawal</span>
                                                        ...
                                                        <div class="accordion-body-text">
                                                            <div class="default-tab">
                                                                <ul class="nav nav-tabs" role="tablist">
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link active" data-bs-toggle="tab" to="#home"><i class="la la-list me-2"></i>Mobile Money Withdrawal</Link>

                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <Link class="nav-link" data-bs-toggle="tab" to="#profile"><i class="la la-credit-card me-2"></i> Bank Withdrawal</Link>
                                                                    </li>
                                                                    {/* <li class="nav-item">
                                                                                                    ...
                                                                                                    <div className="col-lg-12 mb-0">
                                                                                                        <button onClick={() =>
                                                                                                            swal({
                                                                                                                title: "Are you sure?",
                                                                                                                text:
                                                                                                                    "You want to proceed with your withdrawal!",
                                                                                                                icon: "warning",
                                                                                                                buttons: true,
                                                                                                                dangerMode: true,
                                                                                                            }).then((willDelete) => {
                                                                                                                if (willDelete) {
                                                                                                                    ...
                                                                                                                    swal("Withdrawal has been cancelled!");
                                                                                                                }
                                                                                                            })
                                                                                                        } className="btn btn-block" id="login" type="button">Make Withdrawal</button>
                                                                                                    </div>
                                                                                                    {/* // <!--end col--> */}
                                                                                            ...
                                                                                            <form className="login-form mt-4 scroll" id="style">
                                                                                                ...
                                                                                                <div className="row">
                                                                                                    ...
                                                                                                    <button onClick={() =>
                                                                                                        ...
                                                                                                        } className="btn btn-block" id="login" type="button">Make Withdrawal</button>                                                                                                    </div>
                                                                                                    {/* // <!--end col--> */}
