                                            ...
                                            <div class="accordion accordion-primary" id="accordion-one">
                                                <div class="accordion-item">
                                                    <div class="accordion-header " id="headingOne" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne" aria-expanded="true" role="button">
                                                        ...
                                                        <span class="accordion-header-text">Personal Details</span>
                                ...
                                <div className="col-xl-6">
                                    <div className="" >
                                        <div className="card-body" id="LeftBorder">
                                            <h6 className="fs-14"><b>Note:</b></h6>
                                            <span className="fs-14 font-w300">When ordering a product, client should select if the shipping address should be the same as the account address.</span>
                                            <p></p>
